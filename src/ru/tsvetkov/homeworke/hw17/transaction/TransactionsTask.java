package ru.tsvetkov.homeworke.hw17.transaction;
...
public class TransactionsTask {
    public static void main(String[] args) {
        ...
        Map<String, Long> mapSum = transactionStream
                .collect(Collectors.toMap(transaction -> transaction.getAccount().getNumber(),
        ...
        transactionStream = Stream.of(transaction1, transaction2, transaction3,
                transaction4, transaction5, transaction6, transaction7);
        long sum = transactionStream.mapToLong(transaction -> transaction.getAccount().getBalance()).sum();
